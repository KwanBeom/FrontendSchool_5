...
// array와 같은 convension 자료형을 넘길 때 함수 안에서 값이 수정 됨
// 타 언어에서 call by value (값의 전달)
// 타 언어에서 call by reference (참조-주소값의 전달)
// 면접 질문 : 자바스크립트의 call by value, call by reference에 대해 설명하세요
// 답변 : 자바스크립트는 call by value만 존재합니다.
...
test(a)
console.log(a); // 다른 언어의 경우 call by ref로 동작해 값이 바뀜
